...
const DynamicAirborneTraceShape = {
  ...
  runnerUpFamilyScore: z.number().min(0).max(1).optional(),
  secondaryRunnerUpFamily: DynamicAirborneFamilySchema.optional(),
  secondaryRunnerUpFamilyLabel: z.string().min(1).optional(),
  secondaryRunnerUpFamilyScore: z.number().min(0).max(1).optional(),
  selectedLabel: z.string().min(1),
  selectedFamilyScore: z.number().min(0).max(1).optional(),
