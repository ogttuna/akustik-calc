...
const POST_MIXED_FLOOR_WALL_REQUESTED_OUTPUT_HISTORY_REPLAY_GRID_NEXT_SLICE_SELECTION = {
  sliceId: "post_mixed_floor_wall_requested_output_history_replay_grid_next_slice_selection_v1",
  selectedImplementationSlice: "mixed_floor_wall_requested_output_card_history_replay_grid_expansion_v1",
  selectedOutputSurface: "workbench_requested_output_card_history_replay_posture",
  ...
  nextExecutionAction: "mixed_floor_wall_requested_output_card_history_replay_grid_expansion_v1",
  followUpPlanningAction: "post_mixed_floor_wall_requested_output_card_history_replay_grid_next_slice_selection_v1"
} as const;
...
const SELECTED_SHARED_POSTURE_SCOPE = {
  ...
  postureStressors: [
    ...
    "output_card_status_projection_after_cross_mode_history_restore",
...
const DEFERRED_IMMEDIATE_RUNTIME_CANDIDATES = [
  ...
  },
  {
    ...
    reason: "requested_output_card_history_replay_grid_should_land_before_formula_scope_expansion",
    runtimeWideningEligible: false
  },
  {
    id: "wall_selector_behavior_widening",
    reason: "requested_output_card_history_replay_grid_should_land_before_wall_selector_scope_expansion",
    runtimeWideningEligible: false
  }
] as const;

describe("post mixed floor/wall requested-output history replay grid next slice selection contract", () => {
  it("selects requested-output card history replay grid expansion before any runtime widening", () => {
    expect(POST_MIXED_FLOOR_WALL_REQUESTED_OUTPUT_HISTORY_REPLAY_GRID_NEXT_SLICE_SELECTION).toEqual({
      sliceId: "post_mixed_floor_wall_requested_output_history_replay_grid_next_slice_selection_v1",
      selectedImplementationSlice: "mixed_floor_wall_requested_output_card_history_replay_grid_expansion_v1",
      selectedOutputSurface: "workbench_requested_output_card_history_replay_posture",
      selectedRouteFamily: "mixed_floor_wall_seeded_boundary_routes",
  ...
  it("keeps the next scope on the selected seeded route ledger and output-card history replay posture", () => {
