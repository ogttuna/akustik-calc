...
const OPENING = {
  ...
  id: "rated-door-c-ctr-refresh-01",
  origin: "catalogued",
  ...
  openingLeakElements: [
    {
      ...OPENING,
      elementType: "window",
      id: "facade-window-c-ctr-refresh-01"
    }
  ]
} as const satisfies AirborneContext;
...
describe("post-V1 opening/facade door/window C/Ctr lab-companion target-output independence coverage refresh", () => {
  ...
  it("re-probes C and Ctr as request-scoped lab companions for complete indoor field/building requests", () => {
