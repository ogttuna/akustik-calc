...
describe("post-V1 floor user-material low-density exact ASTM companion coverage refresh", () => {
  ...
  it("re-probes lab exact ASTM IIC with low-density ISO and field companions", () => {
  ...
  it("re-probes field exact ASTM AIIC without aliasing ASTM metrics", () => {
    const result = calculateLowDensityFloor({
  ...
  it("keeps opposite ASTM aliases, missing context, and generic ASTM outside the owner", () => {
