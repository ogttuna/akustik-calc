...
const CASES: readonly MatrixCase[] = [
  ...
  },
  {
    ...
    expected: {
      ...
      evidenceTier: "estimate",
      floorRatingsBasis: "predictor_lightweight_concrete_family_estimate",
      floorRw: 53,
      floorRwCtr: 47.5,
      floorSystemEstimateBasis: "predictor_lightweight_concrete_family_estimate",
      floorSystemEstimateKind: "family_general",
      floorSystemMatchId: null,
      impactBasis: "predictor_lightweight_concrete_family_estimate",
      impactCI: 2,
      impactCI50_2500: 5,
      impactDeltaLw: null,
      impactLnW: 64.3,
  ...
  },
  {
    ...
    expected: {
      ...
      unsupportedTargetOutputs: ["Ln,w", "Rw", "Ctr"]
    }
  },
  {
