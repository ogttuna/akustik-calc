  ...
  it("opens safe single-layer raw bare floors onto stable lab and field impact lanes", () => {
    ...
    const cases: Array<{
    ...
    }> = [
      {
        ...
        expected: {
          fieldLPrimeNT50: 66.9,
          fieldLPrimeNTw: 66.9,
          fieldLPrimeNW: 69.3,
          fieldRwPrime: 33,
          fieldSupportedTargetOutputs: ["R'w", "Ln,w", "Ln,w+CI", "L'n,w", "L'nT,w", "L'nT,50"],
          fieldUnsupportedTargetOutputs: ["Rw", "DnT,w", "DnT,A", "Dn,w", "Dn,A"],
      ...
      },
      {
        ...
        expected: {
          ...
          fieldLPrimeNW: 59.9,
          fieldRwPrime: 57,
          fieldSupportedTargetOutputs: ["R'w", "Ln,w", "L'n,w", "L'nT,w"],
          fieldUnsupportedTargetOutputs: ["Rw", "DnT,w", "DnT,A", "Dn,w", "Dn,A", "Ln,w+CI", "L'nT,50"],
