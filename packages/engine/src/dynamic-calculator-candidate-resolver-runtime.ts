...
import {
  ...
  COMPANY_INTERNAL_OPENING_LEAK_SPECTRAL_FIELD_BUILDING_SELECTED_CANDIDATE_ID
...
function familyPhysicsCandidateId(runtimeBasis?: AirborneResultBasis): string {
  if (runtimeBasis?.method === LAYER_COMBINATION_RESOLVER_DOUBLE_LEAF_FRAMED_WALL_BANDED_FORMULA_CORRIDOR_BASIS) {
    return LAYER_COMBINATION_RESOLVER_DOUBLE_LEAF_FRAMED_WALL_BANDED_RUNTIME_CORRIDOR_SELECTED_CANDIDATE_ID;
  }

  if (runtimeBasis?.method === LAYER_COMBINATION_RESOLVER_SINGLE_LEAF_MASS_LAW_BANDED_FORMULA_CORRIDOR_BASIS) {
    return LAYER_COMBINATION_RESOLVER_SINGLE_LEAF_MASS_LAW_BANDED_RUNTIME_CORRIDOR_SELECTED_CANDIDATE_ID;
  }
  ...
  if (runtimeBasis?.method === COMPANY_INTERNAL_OPENING_LEAK_SPECTRAL_FIELD_BUILDING_RUNTIME_METHOD) {
    return COMPANY_INTERNAL_OPENING_LEAK_SPECTRAL_FIELD_BUILDING_SELECTED_CANDIDATE_ID;
  }
  ...
  if (runtimeBasis?.method === BROAD_ACCURACY_WALL_TRIPLE_LEAF_LOCAL_SUBSTITUTION_BUILDING_RUNTIME_METHOD) {
    return BROAD_ACCURACY_WALL_TRIPLE_LEAF_LOCAL_SUBSTITUTION_BUILDING_SELECTED_CANDIDATE_ID;
  }
