...
describe("post-V1 floor user-material low-density exact ASTM field direct-flanking companion coverage refresh", () => {
  ...
  it("re-probes exact field ASTM AIIC with ISO and direct+flanking companions", () => {
  ...
  it("re-probes the same field AIIC direct+flanking companion in complete building context", () => {
    const result = calculateLowDensityFloor({
