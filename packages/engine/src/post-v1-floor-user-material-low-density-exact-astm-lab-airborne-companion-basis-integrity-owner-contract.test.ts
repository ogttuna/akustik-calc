...
describe("post-V1 floor user-material low-density exact ASTM lab-airborne companion basis-integrity owner", () => {
  ...
  it("promotes field exact ASTM Rw and C to the same-stack lightweight-family lab-airborne companion", () => {
  ...
  it("opens complete building-context Rw and C while STC and Ctr remain unsupported without a companion basis", () => {
    const result = calculateLowDensityFloor({
