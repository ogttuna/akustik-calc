...
const SPECTRAL_WINDOW = {
  ...
  id: "oitc-schema-bridge-refresh-window-01",
  origin: "catalogued",
  ...
  openingLeakElements: [
    {
      ...SPECTRAL_WINDOW,
      elementType: "door",
      id: "oitc-schema-bridge-refresh-door-01"
    }
  ]
} as const satisfies AirborneContext;
...
describe("post-V1 opening/facade outdoor-indoor OITC metric schema and adapter bridge coverage refresh", () => {
  ...
  it("re-probes OITC as a valid requested output while keeping complete facade requests unsupported", () => {
  ...
  it("keeps missing facade context as needs_input and indoor OITC as unsupported", () => {
  ...
  it("re-probes mixed lab requests without copying Rw/STC into OITC", () => {
