...
export function DeliveryAssistPanel({
  ...
  const nextMoves = [
    ...
    outputSummary.guideReady.length > 0
      ? guideResult
        ? `Guide supplement is active${typeof guideResult.CI === "number" ? `: CI ${guideResult.CI.toFixed(1)} dB` : ""}${typeof guideResult.CI50_2500 === "number" ? `, CI,50-2500 ${guideResult.CI50_2500.toFixed(1)} dB` : ""}${typeof guideResult.LnWPlusCI === "number" ? `, Ln,w+CI ${guideResult.LnWPlusCI.toFixed(1)} dB` : typeof guideResult.LnWPlusCIUpperBound === "number" ? `, Ln,w+CI <= ${guideResult.LnWPlusCIUpperBound.toFixed(1)} dB` : ""}${typeof guideResult.LPrimeNW === "number" ? `, L'n,w ${guideResult.LPrimeNW.toFixed(1)} dB` : typeof guideResult.LPrimeNWUpperBound === "number" ? `, L'n,w <= ${guideResult.LPrimeNWUpperBound.toFixed(1)} dB` : ""}${typeof guideResult.LPrimeNTw === "number" ? `, L'nT,w ${guideResult.LPrimeNTw.toFixed(1)} dB` : typeof guideResult.LPrimeNTwUpperBound === "number" ? `, L'nT,w <= ${guideResult.LPrimeNTwUpperBound.toFixed(1)} dB` : ""}${typeof guideResult.LPrimeNT50 === "number" ? `, L'nT,50 ${guideResult.LPrimeNT50.toFixed(1)} dB` : typeof guideResult.LPrimeNT50UpperBound === "number" ? `, L'nT,50 <= ${guideResult.LPrimeNT50UpperBound.toFixed(1)} dB` : ""}. ${formatConfidenceLevel(guideResult.confidence.level)}.`
