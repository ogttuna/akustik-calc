...
export const STEEL_BOUND_SUPPORT_FORM_GAP_DETAIL =
  "This lightweight-steel bound lane is still conservative because the live stack leaves the carrier open between steel joist / purlin and open-web / rolled steel. Fix the base-structure row to one support form so DAC can stay inside the narrower FL-32 or FL-33 family-bound corridor.";
