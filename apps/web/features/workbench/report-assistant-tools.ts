...
import type { ReportAssistantToolName } from "./report-assistant-tool-definitions";
...
export {
  ...
  type ReportAssistantToolDefinition,
  type ReportAssistantToolName
} from "./report-assistant-tool-definitions";
