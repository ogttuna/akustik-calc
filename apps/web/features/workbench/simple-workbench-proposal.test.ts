...
describe("simple workbench proposal helpers", () => {
  ...
  it("escapes consultant free text in the printable html while preserving core sections", () => {
    ...
    expect(html).toContain("Rev 01");
      ...
      expect(html).toContain("Visible layer build-up");
      expect(html).toContain("Walking side");
      expect(html).toContain("Ceiling side");
      expect(html).toContain("Total thickness");
      ...
      expect(html).toContain("How to read the values");
      expect(html).toContain("Higher dB is better");
      expect(html).toContain("Lower dB is better");
      expect(html).toContain("Reference Standards");
      ...
      expect(html).toContain("Prediction method");
    ...
    expect(html).toContain("1,400 kg/m³");
      ...
      expect(html).not.toContain("DAC | DYNECHO ACOUSTIC CALCULATOR");
      expect(html).not.toContain("Prepared from the DYNECHO ACOUSTIC CALCULATOR.");
      expect(html).not.toContain("dynamic topology");
      expect(html).not.toContain("solver posture");
      expect(html).not.toContain("operator desk");
    });
