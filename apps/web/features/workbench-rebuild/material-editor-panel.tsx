...
const FIELD_DESCRIPTIONS = {
  ...
  dynamicStiffnessMNm3: "Material property for resilient layers in MN/m3. Impact and floating-floor formula routes use it when the selected layer is resilient.",
  flowResistivityPaSM2: "Material property for porous absorbers in Pa.s/m2. Porous cavity damping routes use it; rigid panels and non-absorptive fills do not.",
