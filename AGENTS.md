...
2. `docs/calculator/CHECKPOINT_2026-04-14_FORMULA_PROVENANCE_DOSSIER_HANDOFF.md`
...
- run `pnpm calculator:gate:current` before and after touching the active mixed
  floor/wall slice
