...
broad source crawl. The next implementation should expand the
package-transfer residual lane for exact-only hybrid / mixed-staged
same-family evidence gaps.
