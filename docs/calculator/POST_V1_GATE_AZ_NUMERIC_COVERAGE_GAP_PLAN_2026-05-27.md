...
| Resolver surface | Current documented count is 40 declared candidates and 37 active runtime-basis mappings. | Any selected runtime follow-up must add candidate and basis mappings only when it publishes owned values. |
