...
| Resolver surface | Historical Gate AZ documented count was 42 declared candidates and 39 active runtime-basis mappings. Later Gate CG2 raised the living resolver surface to 43 declared candidates and 40 active runtime-basis mappings. | Any selected runtime follow-up must add candidate and basis mappings only when it publishes owned values. |
