...
Current-state override, 2026-06-05: this roadmap is strategic accuracy
...
numeric coverage-gap label. Older source-acquisition or source-gap
statements below are historical unless reselected by the current
post-V1 plan.
