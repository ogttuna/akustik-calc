...
`wall_double_leaf_sharp_davy_scoping_v1` Gate B, which must not change
calculator runtime/source posture unless a source-backed,
benchmark-backed, formula-tolerance-owned, or bounded family candidate
