...
`wall_coverage_expansion_planning_v2` selected)
...
- **2026-04-27 update**: `calculator_source_gap_revalidation_v1` Gate A
  ...
  selected `wall_coverage_expansion_planning_v2`; Gate A of that slice
  must inventory wall coverage before changing calculator formulas,
