...
As of 2026-06-08, the living implementation state has advanced through
Gate ET. Gate ET is the latest no-runtime calculator boundary slice:
...
The active next action is Gate EU:
