...
4. Current clean checkpoint / restart point: [calculator/CHECKPOINT_2026-04-16_RUNTIME_CANDIDATE_RERANK_HANDOFF.md](./calculator/CHECKPOINT_2026-04-16_RUNTIME_CANDIDATE_RERANK_HANDOFF.md)
...
- If the question is "where do I resume implementation now?":
  read [calculator/CHECKPOINT_2026-04-16_RUNTIME_CANDIDATE_RERANK_HANDOFF.md](./calculator/CHECKPOINT_2026-04-16_RUNTIME_CANDIDATE_RERANK_HANDOFF.md),
...
- [calculator/CHECKPOINT_2026-04-16_RUNTIME_CANDIDATE_RERANK_HANDOFF.md](./calculator/CHECKPOINT_2026-04-16_RUNTIME_CANDIDATE_RERANK_HANDOFF.md): current clean restart point, latest validation gate, post-harness runtime rerank closeout, and explicit not-done list
...
- use `CHECKPOINT_2026-04-16_RUNTIME_CANDIDATE_RERANK_HANDOFF.md` for “where the next agent should resume”
