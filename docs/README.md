...
- Active slice detailed plan (wall hostile input matrix with airborne cartography):
...
- Previous slice detailed plan (LSF + timber stud preset pack with physical invariants, closed 2026-04-21):
